...
{
    public partial class B403_eTicaretContext : DbContext
    {
        static B403_eTicaretContext()
        {
            Database.SetInitializer<B403_eTicaretContext>(null);
        }

        public B403_eTicaretContext()
            : base("Name=B403_eTicaretContext")
        {
        }
